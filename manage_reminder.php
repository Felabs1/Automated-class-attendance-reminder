    ...
    <div class="w3-auto">
        ...
        <?php  
            if(isset($_GET['reminder_id'])){
                ...
                <form id="reminder" class="w3-white w3-padding w3-round-large">
                    ...
                    <input class="w3-input w3-border w3-round" type="time" value="<?php echo $fetch2[0]["time"]; ?>" name="time" id="time"/>
                    <label for="">venue</label>
                    <input class="w3-input w3-border w3-round" name="venue" value="<?php echo $fetch2[0]["venue"]; ?>"  id="venue"/>
                    <label for="">group</label>
                    <select class="w3-select w3-border w3-round" value="<?php echo $fetch2[0]["group"]; ?>"   name="group" id="group">
                        <?php 
                    ...
                    <select class="w3-select w3-border w3-round" id="day_of_the_week" value="<?php echo $fetch2[0]["dayOfTheWeek"]; ?>"   name="day_of_the_week">
        ...
        <table class="w3-table w3-bordered">
            ...
            foreach($fetch as $row){
                ...
                ?>
                 <tr>
                    <td><?php echo $row['reminder_id']; ?></td>
                    <td><?php echo $row['unit']; ?></td>
                    <td><?php echo $row['time']; ?></td>
                    <td><?php echo $row['venue']; ?></td>
                    <td><?php echo $row['group']; ?></td>
                    <td><?php echo $row['dayOfTheWeek']; ?></td>
                    <td><a href="manage_reminder.php?reminder_id=<?php echo $row["reminder_id"]; ?>" class="w3-button w3-padding-small w3-grey w3-round">Edit</a>&nbsp;<button class="w3-button w3-padding-small w3-red w3-round">Delete</button></td>
                </tr>
                <?php
            }
             ?>
